...
public class ClientsHome {
	...
	public Clients merge(Clients detachedInstance) {
		...
		try {
			Clients result = (Clients) sessionFactory.getCurrentSession()
	...
	public Clients findById(java.lang.Integer id) {
		log.debug("getting Clients instance with id: " + id);
		try {
			Clients instance = (Clients) sessionFactory.getCurrentSession()
					.get("persistance.Clients", id);
			if (instance == null) {
	...
	public List<Clients> findByExample(Clients instance) {
		log.debug("finding Clients instance by example");
		try {
			List<Clients> results = (List<Clients>) sessionFactory
					.getCurrentSession().createCriteria("persistance.Clients")
